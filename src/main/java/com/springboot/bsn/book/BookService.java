...
import com.springboot.bsn.file.FileStorageService;
import com.springboot.bsn.history.BookTransactionHistory;
import com.springboot.bsn.history.BookTransactionHistoryRepository;
...
import static com.springboot.bsn.book.BookSpecification.withOwnerId;
...
public class BookService {
    ...
    public void uploadBookCoverImage(MultipartFile file, Authentication connectedUser, Integer bookId) throws IOException {
        Book book = bookRepository.findById(bookId)
                .orElseThrow(() -> new EntityNotFoundException("No Book Found with the ID: " + bookId));
        User user = ((User) connectedUser.getPrincipal());
